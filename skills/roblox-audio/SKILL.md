...
name: roblox-audio
description: >
  Audio implementation for Roblox. Both legacy Sound objects and the newer modular
  audio system (AudioPlayer, AudioEmitter, Wire). Positional audio, music, SFX,
  SoundGroups, dynamic effects. Sourced from official Roblox creator docs.
last_reviewed: 2026-05-27
sources:
  - https://github.com/Roblox/creator-docs/blob/main/content/en-us/sound/objects.md
  - https://github.com/Roblox/creator-docs/blob/main/content/en-us/audio/objects.md
  - https://github.com/Roblox/creator-docs/blob/main/content/en-us/sound/groups.md
  - https://github.com/Roblox/creator-docs/blob/main/content/en-us/sound/dynamic-effects.md
  - https://github.com/Roblox/creator-docs/blob/main/content/en-us/tutorials/use-case-tutorials/audio/play-background-music.md
---

# Roblox Audio

Roblox has two audio systems. The **legacy system** uses `Sound`, `SoundGroup`, and `SoundEffect` objects. The **new modular system** uses `AudioPlayer`, `AudioEmitter`, `AudioListener`, `Wire`, and `AudioDeviceOutput`. The new system is preferred for new projects but the legacy system still works and is simpler for basic use cases.
