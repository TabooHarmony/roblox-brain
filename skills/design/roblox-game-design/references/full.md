...
- **Novelty** — a hook: something unique or fun that makes the game memorable and shareable.
...
3. **Ten (Twist)** — the "aha!": the mechanic is flipped — used in an unexpected way, inverted, or combined with itself in a new context. This is the fresh challenge.
...
**Trading systems = inflation risk + earnings sink:** the biggest earners (Fortnite; Rivals — #1 earning game on Roblox) all skip trading entirely.
