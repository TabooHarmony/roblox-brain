...
name: roblox-tooling
description: >
  Modern Roblox development toolchain: Rojo, Wally, Selene, StyLua, Lune, Aftman.
  Filesystem-based workflows, Git integration, CI/CD, and editor setup. Use when setting up
  or working with the professional Roblox development stack.
last_reviewed: 2026-05-27
sources:
  - https://github.com/brockmartin/roblox-game-skill/blob/main/references/tooling-ecosystem.md (MIT)
  - https://rojo.space/docs
  - https://wally.run
---

# Roblox Tooling Ecosystem

## When to Use

Load this skill when the task involves:

- Setting up Rojo for filesystem-to-Studio sync
- Configuring Wally for package management
- Setting up linting (Selene) and formatting (StyLua)
- Configuring luau-lsp for editor IntelliSense
- Writing CI/CD pipelines for Roblox projects
- Understanding file naming conventions (`.server.luau`, `.client.luau`, etc.)
- Setting up Aftman for toolchain management
- Using Lune for headless Luau execution

**Hand off to other skills when:**

- Writing the actual game code → domain-specific skills (`roblox-networking`, `roblox-data`, etc.)
- Luau language questions → `roblox-luau-core`, `roblox-luau-types`
- Testing patterns → `roblox-testing`
