...
<img src="assets/demo.gif" alt="Animated demo: Roblox code without roblox-brain breaks on phones, trusts client prices, loses progress, and leaks memory; with roblox-brain each is fixed. Then the 29 skills and the install command, npx skills add TabooHarmony/roblox-brain" width="75%">
